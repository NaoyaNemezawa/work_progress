...
## このアプリケーションの概要
本アプリは、チームで行っている作業の進捗状況を共有し、管理を用意にするアプリケーションです。
...
（以下の動画ではテスト用第１号アカウントでログイン、プロジェクト「青い猫型ロボット製造計画」に」テスト用第３号を招待しています。）
![readme用動画１](https://user-images.githubusercontent.com/71652340/106718192-0e615080-6644-11eb-8f19-c65cf2434e83.gif)

なお招待されていないユーザーには情報は公開されず、情報を秘匿することができます。（以下の画像ではテスト用第２号でログインしています。当該アカウントはテスト用第１号のアカウントが作成したプロジェクト「プロジェクト作成確認」に招待されていないため、内容を閲覧することはできません。）
...
- プロジェクト被招待・コメント投稿確認用アカウント
  ...
  <br>email:test2@test 
  <br>password:test222
- プロジェクト追加招待・コメント投稿確認用アカウント
  <br>アカウント名：テスト用第3号
  <br>email:test3@test 
  <br>password:test333
  <br>
  <br>＊権限付与機能は実装していないため、いずれのアカウントを使用しても同じことができます。
...
## DB設計図
<img width="950" alt="readme用１" src="https://user-images.githubusercontent.com/71652340/106730954-466f9000-6652-11eb-93e6-3f179c9b8d8c.png">
